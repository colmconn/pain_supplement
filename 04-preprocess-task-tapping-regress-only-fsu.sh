...
#     excessiveMotionThresholdFraction=0.40
#     excessiveMotionThresholdPercentage=40
...
for ff in ../\${parent_analysis}/pb* \\
    ...
    ../\${parent_analysis}/dfile.r* \\
    ../\${parent_analysis}/dfile_rall.1D \\
    ...
    ../\${parent_analysis}/out.tedana_version.txt \\
    ../\${parent_analysis}/out.vlines.pb00.tcat.txt \\
    ../\${parent_analysis}/tedana_r* \\
...
# ================================ regress =================================
if [[ \${subj} == "sub-177_ses-baseline" ]] ; then
    # compute de-meaned motion parameters (for use in regression)
    1d_tool.py -infile dfile_rall.1D -set_run_lengths 200 263             \\
