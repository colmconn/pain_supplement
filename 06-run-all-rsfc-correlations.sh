...
seedFiles="primary-sensory-cortex-seeds.txt fox-dmn-seeds.txt krienen-dlpfc-seeds.txt kelly-insula-seeds.txt goldapple-dlpfc-seeds.txt goldapple-dacc-mpfc-seeds.txt"
